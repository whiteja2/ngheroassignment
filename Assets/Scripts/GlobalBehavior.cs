...
public class GlobalBehavior : MonoBehaviour {
    ...
    #endregion
	#region EnemyMode support
    public Text mEnemyModeEcho = null;  // Defined in UnityEngine.UI
    private bool mEnemyMode = false;
    #endregion
	#region EggCooldown support
	...
	{
		mEnemyMode = !mEnemyMode;
		EchoEnemyMode();  
	}
    private void EchoEnemyMode()
    {
		if (mEnemyMode)
		{
			mEnemyModeEcho.text = "Enemy Mode: Random";
		}
        else
		{
			mEnemyModeEcho.text = "Enemy Mode: Sequential";
		}
    }
    #endregion
	#region EggCooldown support
